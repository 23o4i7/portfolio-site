...
export default function Navbar() {
  return (
    <div className="fixed top-0 left-0 z-50 w-full">
      <div className="flex flex-row items-center justify-between border-2 border-snow-white mx-auto mt-5 md:px-32 h-28 w-9/12 backdrop-brightness-[.70] backdrop-blur-sm text-snow-white text-lg font-bold rounded-xl drop-shadow-lg">
