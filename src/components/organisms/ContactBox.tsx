    ...
    <>
      <div className='py-16'>
        ...
        <div className='flex flex-row justify-center py-2'>
          <a href="mailto: sean.ng.cip@gmail.com" rel="noopener noreferrer" target="_blank">
            <Image src="/images/email.svg" alt="Email" width={45} height={45} />
          </a>
          <a href="https://www.linkedin.com/in/sean-ng-23o4i7/" rel="noopener noreferrer" target="_blank">
            <Image src="/images/linkedin.svg" alt="LinkedIn" width={45} height={45} />
          </a>
          <a href="https://github.com/23o4i7" rel="noopener noreferrer" target="_blank">
